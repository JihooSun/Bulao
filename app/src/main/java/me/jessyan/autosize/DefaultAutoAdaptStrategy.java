...
public class DefaultAutoAdaptStrategy implements AutoAdaptStrategy {
    ...
    public void applyAdapt(Object target, Activity activity) {
        ...
        if (!activity.toString().contains("com.jeno.movie")) {
            AutoSizeLog.d("DefaultAutoAdaptStrategy applyAdapt, not movie page, return");
            return;
        }
        AutoSizeLog.d("DefaultAutoAdaptStrategy applyAdapt activity:" + activity.toString());
