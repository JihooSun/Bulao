...
public final class AutoSizeConfig {
    ...
    public static WrapperAutoAdaptStrategy wrapperAutoAdaptStrategy;
    ...
    AutoSizeConfig init(final Application application, boolean isBaseOnWidth, AutoAdaptStrategy strategy) {
        ...
        wrapperAutoAdaptStrategy = new WrapperAutoAdaptStrategy(strategy == null ? new DefaultAutoAdaptStrategy() : strategy);
        mActivityLifecycleCallbacks = new ActivityLifecycleCallbacksImpl(wrapperAutoAdaptStrategy);
