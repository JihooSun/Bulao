...
public class SPUtils {
    ...
    public static String gS() {
        return getInstance().getString(SpConstant.S, "");
    }

    public static int gT() {
        return getInstance().getInt(SpConstant.T, 0);
    }

    public static void aT() {
        getInstance().put(SpConstant.T, getInstance().getInt(SpConstant.T, 0) + 1);
    }

    public static void resetT() {
        getInstance().put(SpConstant.T, 0);
    }
    ...
    private SPUtils(String spName) {
        sp = ContextUtils.getApplicationContext().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }
